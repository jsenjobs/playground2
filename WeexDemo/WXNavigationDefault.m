...
@interface JWXBarButton :UIButton
...
@implementation JWXBarButton

@end

@implementation WXNavigationDefault
...
withContainer:(UIViewController *)container {
    ...
    WXBase2ViewController *vc = [[WXBase2ViewController alloc]initWithSourceURL:[NSURL URLWithString:param[@"url"]]];
    vc.hidesBottomBarWhenPushed = YES;
    
    // [container.navigationController popToRootViewControllerAnimated:NO];

    /*
    NSMutableArray *viewCtrs = [NSMutableArray arrayWithArray:container.navigationController.viewControllers];
    ...
    [container.navigationController setViewControllers:viewCtrs animated:YES];
    */
    UIWindow* window = [UIApplication sharedApplication].keyWindow;
    window.rootViewController = [[WXRootViewController alloc] initWithRootViewController:vc];
        ...
        withContainer:(UIViewController *)container
{
    if (param[@"title"]) {
        ...
        JWXBarButton *button = [JWXBarButton buttonWithType:UIButtonTypeRoundedRect];
        ...
        if (icon) {
            ...
            [self downloadImageWithURL:icon imageFrame:CGRectMake(0, 0, 25, 25) userInfo:nil completed:^(UIImage *image, NSError *error, BOOL finished) {
...
{
    JWXBarButton *button = (JWXBarButton *)sender;
