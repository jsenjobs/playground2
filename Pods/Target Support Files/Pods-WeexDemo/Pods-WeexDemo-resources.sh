...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/GCanvas/GCanvas.framework/default.glsl"
  install_resource "${PODS_ROOT}/GCanvas/GCanvas.framework/grad.glsl"
  install_resource "${PODS_ROOT}/GCanvas/GCanvas.framework/pattern.glsl"
  install_resource "${PODS_ROOT}/GCanvas/GCanvas.framework/radiation.glsl"
  install_resource "${PODS_ROOT}/../../../pre-build/native-bundle-main.js"
